...
<form method="post" action="{{ route('buy_now.confirm', $product->id) }}" enctype="multipart/form-data">
    @csrf
    <div class="row">
        <div class="col-6">
            <div class="row">
                ...
                <div class="form-group mt-3">
                    ...
                    <input type="text" class="form-control" value="{{ rupiah($cost_value) }}" placeholder="">
                ...
                <div class="form-group mt-3">
                    ...
                    <textarea class="form-control @error('address') is-invalid @enderror" rows="5" name="address" id="alamat"
        ...
        <div class="col-6">
            <div class="checkout-cart-total">
                ...
                <ul style="list-style:none;">
                    ...
                    <li><span class="left">{{ $product->product_name }} X {{ $qty }}
                        </span> <span class="right">{{ $product->price * $qty }} </span></li>
